/**
 *  HomeAssistant Devices (Climate) v2022-04-23
 *  clipman@naver.com
 *  날자
 *
...
metadata {
	definition (name: "HomeAssistant Devices (Climate)", namespace: "clipman", author: "clipman", ocfDeviceType: "oic.d.thermostat") {
		capability "Switch"
	...
	preferences {
		...
		input type: "paragraph", element: "paragraph", title: "HomeAssistant Devices (Climate) v2022-04-23", description: "", displayDuringSetup: false
	}
}
